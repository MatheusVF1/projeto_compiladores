...
_lr_productions = [
  ...
  ('programa_minipar -> bloco_stmt','programa_minipar',1,'p_programa_minipar','analisador_lexico.py',17),
  ('bloco_stmt -> bloco_SEQ','bloco_stmt',1,'p_bloco_stmt','analisador_lexico.py',21),
  ('bloco_stmt -> bloco_PAR','bloco_stmt',1,'p_bloco_stmt','analisador_lexico.py',22),
  ('bloco_stmt -> bloco_stmt bloco_SEQ','bloco_stmt',2,'p_bloco_stmt','analisador_lexico.py',23),
  ('bloco_stmt -> bloco_stmt bloco_PAR','bloco_stmt',2,'p_bloco_stmt','analisador_lexico.py',24),
  ('bloco_SEQ -> SEQ stmts','bloco_SEQ',2,'p_bloco_SEQ','analisador_lexico.py',31),
  ('bloco_PAR -> PAR stmts','bloco_PAR',2,'p_bloco_PAR','analisador_lexico.py',35),
  ('bloco_IF -> IF LPAREN bool RPAREN LBRACE stmts RBRACE','bloco_IF',7,'p_bloco_IF','analisador_lexico.py',39),
  ('bloco_WHILE -> WHILE LPAREN bool RPAREN LBRACE stmts RBRACE','bloco_WHILE',7,'p_bloco_WHILE','analisador_lexico.py',43),
  ('bloco_INPUT -> INPUT LPAREN RPAREN','bloco_INPUT',3,'p_bloco_INPUT','analisador_lexico.py',47),
  ('bloco_OUTPUT -> OUTPUT LPAREN output_args RPAREN','bloco_OUTPUT',4,'p_bloco_OUTPUT','analisador_lexico.py',51),
  ('output_args -> expr','output_args',1,'p_output_args','analisador_lexico.py',55),
  ('output_args -> output_args COMMA expr','output_args',3,'p_output_args','analisador_lexico.py',56),
  ('stmts -> stmt','stmts',1,'p_stmts','analisador_lexico.py',63),
  ('stmts -> stmts stmt','stmts',2,'p_stmts','analisador_lexico.py',64),
  ('stmt -> atribuicao','stmt',1,'p_stmt','analisador_lexico.py',71),
  ('stmt -> bloco_IF','stmt',1,'p_stmt','analisador_lexico.py',72),
  ('stmt -> bloco_WHILE','stmt',1,'p_stmt','analisador_lexico.py',73),
  ('stmt -> bloco_INPUT','stmt',1,'p_stmt','analisador_lexico.py',74),
  ('stmt -> bloco_OUTPUT','stmt',1,'p_stmt','analisador_lexico.py',75),
  ('stmt -> c_channel','stmt',1,'p_stmt','analisador_lexico.py',76),
  ('stmt -> c_channel_stmt','stmt',1,'p_stmt','analisador_lexico.py',77),
  ('atribuicao -> ID EQUALS expr','atribuicao',3,'p_atribuicao','analisador_lexico.py',81),
  ('atribuicao -> ID EQUALS STRING','atribuicao',3,'p_atribuicao','analisador_lexico.py',82),
  ('atribuicao -> ID EQUALS bloco_INPUT','atribuicao',3,'p_atribuicao','analisador_lexico.py',83),
  ('atribuicao -> ID EQUALS receive_stmt','atribuicao',3,'p_atribuicao','analisador_lexico.py',84),
  ('expr -> INT','expr',1,'p_expr','analisador_lexico.py',91),
  ('expr -> STRING','expr',1,'p_expr','analisador_lexico.py',92),
  ('expr -> expr PLUS expr','expr',3,'p_expr','analisador_lexico.py',93),
  ('expr -> expr MINUS expr','expr',3,'p_expr','analisador_lexico.py',94),
  ('expr -> expr TIMES expr','expr',3,'p_expr','analisador_lexico.py',95),
  ('expr -> expr DIVIDE expr','expr',3,'p_expr','analisador_lexico.py',96),
  ('expr -> expr LESS_THAN expr','expr',3,'p_expr','analisador_lexico.py',97),
  ('expr -> expr GREATER_THAN expr','expr',3,'p_expr','analisador_lexico.py',98),
  ('expr -> expr LESS_THAN_EQUALS expr','expr',3,'p_expr','analisador_lexico.py',99),
  ('expr -> expr GREATER_THAN_EQUALS expr','expr',3,'p_expr','analisador_lexico.py',100),
  ('expr -> expr EQUALS_EQUALS expr','expr',3,'p_expr','analisador_lexico.py',101),
  ('expr -> expr NOT_EQUALS expr','expr',3,'p_expr','analisador_lexico.py',102),
  ('expr -> ID','expr',1,'p_expr_id','analisador_lexico.py',111),
  ('bool -> expr','bool',1,'p_bool','analisador_lexico.py',118),
  ('comment -> COMMENT','comment',1,'p_comment','analisador_lexico.py',122),
  ('c_channel -> C_CHANNEL ID LPAREN STRING COMMA STRING RPAREN','c_channel',7,'p_c_channel','analisador_lexico.py',126),
  ('c_channel_stmt -> send_stmt','c_channel_stmt',1,'p_c_channel_stmt','analisador_lexico.py',132),
  ('c_channel_stmt -> receive_stmt','c_channel_stmt',1,'p_c_channel_stmt','analisador_lexico.py',133),
  ('send_stmt -> ID DOT SEND LPAREN ID COMMA expr COMMA expr COMMA expr RPAREN','send_stmt',12,'p_send_stmt','analisador_lexico.py',137),
  ('send_stmt -> ID DOT SEND LPAREN ID RPAREN','send_stmt',6,'p_send_stmt','analisador_lexico.py',138),
  ('receive_stmt -> ID DOT RECEIVE LPAREN ID COMMA expr COMMA expr COMMA expr RPAREN','receive_stmt',12,'p_receive_stmt','analisador_lexico.py',149),
  ('receive_stmt -> ID DOT RECEIVE LPAREN ID RPAREN','receive_stmt',6,'p_receive_stmt','analisador_lexico.py',150),
]
